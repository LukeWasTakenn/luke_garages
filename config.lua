...
Config.Garages = {
    ...
    {
        label = 'Appartement garage',
        type = 'car',
        pedCoords = {x = -296.0586, y = -992.7943, z = 30.0806, h = 349.1869},
        zone = {name = 'apartment', x = -315.4348, y = -984.0026, z = 31.0806, l = 43, w = 8, h = 250, minZ = nil, maxZ = nil},
        spawns = {
            {x = -301.1344, y = -989.3895, z = 30.4395, h = 340},
            {x = -304.5826, y = -987.1479, z = 30.4395, h = 340},
            {x = -308.3426, y = -986.8655, z = 30.4395, h = 340},
            {x = -311.8235, y = -985.3166, z = 30.4397, h = 340},
            {x = -315.3689, y = -984.1082, z = 30.4397, h = 340},
            {x = -318.5235, y = -982.4056, z = 30.4397, h = 340},
            {x = -321.8505, y = -981.0251, z = 30.4397, h = 340},
        }
    },
    --[[ 
        TEMPLATE:
